...
| [garage.md](garage.md) | Plan for 0.13: a ship's full stat sheet from the community dump, try a part and see what moves, save the build, shop for it - with what can be recomputed and what (EM/IR) can only be estimated. |
